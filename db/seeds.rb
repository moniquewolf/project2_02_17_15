...
Post.create(title: 'Quinoa Salad', body: 'SUPER GREEN QUINOA SALAD WITH FRESH BASIL + PISTACHIOS
...
Blend everything together on high until smooth. Store it in an air-tight container, refrigerated, for up to a week.', photo: File.new("#{Rails.root}/app/assets/images/avocadoToastFNL.png"))
